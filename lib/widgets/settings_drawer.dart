...
/// -----------------------------------------------------------------------
/// The side drawer (hamburger menu, top-left) — Light/Dark toggle and the
/// 5 accent-color swatches. This is the ONLY place theme is changed; no
/// per-screen theme controls anywhere else.
library;
